...
void MD_MAX72XX::begin(void)
{
  ...
  control(DECODE, 0);                 // ensure no decoding (warm boot potential issue)
  clear();
  control(SHUTDOWN, 0);               // take the modules out of shutdown mode
}
